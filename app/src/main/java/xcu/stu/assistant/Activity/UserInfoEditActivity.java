...
public class UserInfoEditActivity extends Activity {
    ...
    private void info_edit() {
        ...
        if (TextUtils.isEmpty(name) && TextUtils.isEmpty(pass) && TextUtils.isEmpty(pass_again) &&
                TextUtils.isEmpty(phone) && TextUtils.isEmpty(qq) && imgUri == null) {//未做任何输入
            AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
            builder.setTitle("提示");
            builder.setMessage("确定放弃修改吗吗？");
                    ...
                    user_img.uploadblock(mContext, new UploadFileListener() {
                        ...
                        public void onSuccess() {
                            ...
                            me.update(mContext, userId, new UpdateListener() {
                                ...
                                public void onSuccess() {
                                    //更新保存的密码
                                    SharedPreferences preferences = getSharedPreferences(myConstant.SP_NAME,
